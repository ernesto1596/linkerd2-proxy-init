...
POD_IGNORES_SUBNETS_OUTBOUND_IP=$(kip pod-ignores-subnets-outbound)
echo "POD_IGNORES_SUBNETS_OUTBOUND_IP=${POD_IGNORES_SUBNETS_OUTBOUND_IP}"
...
k run iptables-tester \
        ...
        --env=POD_IGNORES_SUBNETS_OUTBOUND_IP="${POD_IGNORES_SUBNETS_OUTBOUND_IP}" \
